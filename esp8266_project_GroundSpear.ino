#include <ESP8266WiFi.h>e wwenr re werw 
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    */
    //skiftet fra esp8266client til esp8266client02
...
void loop() {
  ...
  // skift til et andet navn!!! FRA:    client.connect("ESP8266Client"); ... TIL:
    client.connect("ESP8266Clint2");
  ...
  if (now - lastMeasure > 15000) {
    ...
    // Ground humidity test
    //client.publish("/esp8266/temperature_2", temperatureTemp_2);
    // DHT22 - temp + humidity
